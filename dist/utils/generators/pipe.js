...
var PipeGenerator = (function (_super) {
    __extends(PipeGenerator, _super);
    function PipeGenerator() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'pipe';
        return _this;
    }
    PipeGenerator.prototype.getOptions = function (appData, consoleArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var pipesPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pipesPath = (appData.isApp && fs_1.existsSync(appData.path + "/shared"))
                            ? 'shared/pipes'
                            : 'pipes';
                        this.options = [
