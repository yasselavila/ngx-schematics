...
var ModelGenerator = (function (_super) {
    ...
    ModelGenerator.prototype.getOptions = function (appData, consoleArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var modelsPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modelsPath = (appData.isApp && fs_1.existsSync(appData.path + "/shared"))
                            ? 'shared/models'
                            : 'models';
                        this.options = [
