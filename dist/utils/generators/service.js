...
var ServiceGenerator = (function (_super) {
    __extends(ServiceGenerator, _super);
    function ServiceGenerator() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'service';
        return _this;
    }
    ServiceGenerator.prototype.getOptions = function (appData, consoleArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var svcPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        svcPath = (appData.isApp && fs_1.existsSync(appData.path + "/shared"))
                            ? 'shared/services'
                            : 'services';
                        this.options = [
