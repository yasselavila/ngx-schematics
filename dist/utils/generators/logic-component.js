...
var LogicComponentGenerator = (function (_super) {
    __extends(LogicComponentGenerator, _super);
    function LogicComponentGenerator() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'logic-component';
        return _this;
    }
    LogicComponentGenerator.prototype.getOptions = function (appData, consoleArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var cmpPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cmpPath = (appData.isApp && fs_1.existsSync(appData.path + "/shared"))
    ...
    return LogicComponentGenerator;
}(generator_1.BaseGenerator));
exports.LogicComponentGenerator = LogicComponentGenerator;
