...
var SubPageGenerator = (function (_super) {
    __extends(SubPageGenerator, _super);
    function SubPageGenerator() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = 'sub-page';
        return _this;
    }
    SubPageGenerator.prototype.getOptions = function (appData, consoleArgs) {
        return __awaiter(this, void 0, void 0, function () {
            var pagesPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pagesPath = (appData.isApp && fs_1.existsSync(appData.path + "/shared"))
                            ? 'shared/pages'
                            : 'pages';
                        this.options = [
                            {
    ...
    return SubPageGenerator;
}(generator_1.BaseGenerator));
exports.SubPageGenerator = SubPageGenerator;
